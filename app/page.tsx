...
export default function Home() {
  ...
  useEffect(() => {
    ...
    const PUZZLES: Puzzle[] = [
      ...
      {
        sourceSearch: "Joe Cocker Woman to Woman",
        ...
        siblings: [
          {
            ...
            artist: "2Pac",
            year: 1996,
            note: "Same All Eyez on Me album",
          },
          {
            title: "All Eyez on Me",
            artist: "2Pac",
            year: 1996,
            note: "Title track of the double album",
          },
        ],
      },
      {
        sourceSearch: "Edwin Birdsong Cola Bottle Baby",
        answerSearch: "Daft Punk Harder Better Faster",
        source: { title: "Cola Bottle Baby", artist: "Edwin Birdsong", year: 1979 },
        answer: {
      ...
      {
        sourceSearch: "Slave Watching You",
      ...
      {
        sourceSearch: "Nina Simone Strange Fruit",
        ...
        hint: "A dark, orchestral Kanye West track from Yeezus — built on a haunting protest song",
        ...
        siblings: [
          ...
          },
          {
            ...
            year: 1939,
            note: "The original recording of this protest anthem",
          },
        ],
      },
      {
      ...
      {
        sourceSearch: "Tom Scott California Dreamers Today",
        answerSearch: "Pete Rock CL Smooth They Reminisce Over You",
        source: {
          title: "Today",
        ...
        hint1: "A tribute to a late friend — one of hip-hop's most beloved and emotional tracks",
        hint: "Pete Rock & C.L. Smooth's ode to their friend Trouble T Roy — a golden age classic",
        genre: "East Coast Hip-Hop",
        sampleAt: 0,
        siblings: [
          {
            ...
            artist: "The Notorious B.I.G.",
            year: 1994,
            note: "Same golden age soul-sample era",
          },
          {
            title: "C.R.E.A.M.",
            artist: "Wu-Tang Clan",
            year: 1993,
            note: "Same '90s East Coast golden age",
          },
        ],
      },
      {
        sourceSearch: "Ahmad Jamal I Love Music",
        ...
        hint: "A defining track from Nas's debut Illmatic — Pete Rock flipped the piano loop",
        genre: "East Coast Hip-Hop",
        sampleAt: 0,
        siblings: [
          {
          ...
          },
          {
            ...
            year: 1984,
            note: "Also sampled in this track",
          },
        ],
      },
      {
      ...
      {
        sourceSearch: "Otis Redding It's Too Late",
        answerSearch: "Kanye West Gone",
        source: { title: "It's Too Late", artist: "Otis Redding", year: 1965 },
        answer: {
          title: "Gone",
          artist: "Kanye West ft. Consequence & Cam'ron",
          year: 2005,
        },
        hint1: "A 2005 deep cut built on a sped-up soul vocal from a legend",
        hint: "A Late Registration deep cut by Kanye, closing the album with a classic Otis Redding flip",
      ...
      {
        sourceSearch: "Ronnie Foster Mystic Brew",
        answerSearch: "Tribe Called Quest Electric Relaxation",
        source: {
          title: "Mystic Brew",
          artist: "Ronnie Foster",
          year: 1972,
        },
        answer: { title: "Electric Relaxation", artist: "A Tribe Called Quest", year: 1993 },
        hint1: "A laid-back '90s track from a group known for jazz-infused hip-hop",
        hint: "A Tribe Called Quest classic from Midnight Marauders — 'relax yourself girl, please settle down'",
        ...
        siblings: [
          {
            ...
            year: 1990,
            note: "Same group's earlier classic",
          },
          {
            title: "Scenario",
            artist: "A Tribe Called Quest",
            year: 1991,
            note: "Same Tribe catalog",
          },
        ],
      },
      {
        sourceSearch: "David McCallum The Edge",
      ...
      {
        sourceSearch: "Timmy Thomas Why Can't We Live Together",
        ...
        siblings: [
          {
            ...
            artist: "Drake",
            year: 2016,
            note: "Same dancehall-influenced era",
          },
          {
            title: "God's Plan",
            artist: "Drake",
            year: 2018,
            note: "Another Drake chart-topper",
          },
        ],
      },
      {
      ...
      { sourceSearch:"Smokey Robinson Will You Love Me Tomorrow", answerSearch:"Kanye West Devil in a New Dress",
        source:{title:"Will You Love Me Tomorrow",artist:"Smokey Robinson",year:1970},
    ...
    const ALL_SONGS = [
      ...
      {title:"Gone",artist:"Kanye West ft. Consequence & Cam'ron"},
      {title:"Poetic Justice",artist:"Kendrick Lamar"},
      {title:"They Reminisce Over You (T.R.O.Y.)",artist:"Pete Rock & C.L. Smooth"},
